...
<ul class="breadcrumb">
	...
	<li><a href="<c:url value='/companyDetail.do?id=${company.id}'/>">Company detail ${company.companyName}</a>
		<i class="icon-angle-right"></i></li>
	<li><a href="#">Reports (${department.departmentName})</a></li>
</ul>
<!-- end: Breadcrumb -->
...
<form:form method="POST" commandName="department">
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header">
				<h2>
					<i class="halflings-icon align-justify"></i><span class="break"></span>${department.departmentName}
					- Reports
				</h2>
				<div class="box-icon">
					<a href="#"
				...
				<table id="myTable"
					...
					<tbody>
						<c:forEach var="reportexecution" varStatus="status"
							items="${department.reportExecutions}">
							<c:if
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
				...
				<%-- <a href="<c:url value='/reportExecutionDepartmentDetail.do?id=${department.id}&type=DM'/>"><span
					class="btn btn-important btn-danger">Create DMO Declaracion Movimientos</span></a> --%>
				<span class="btn btn-important">Create DMO Declaracion Movimientos</span>	
				
				<a href="<c:url value='/reportExecutionDepartmentDetail.do?id=${department.id}&type=DN'/>"><span
					class="btn btn-important btn-danger">Create DMO Declaracion Negativa</span></a>
				
				<a href="<c:url value='/reportExecutionDepartmentDetail.do?id=${department.id}&type=DP'/>"><span
					class="btn btn-important btn-danger">Create DMO Declaracion Positiva</span></a>
				
				<a href="<c:url value='/reportExecutionDepartmentDetail.do?id=${department.id}&type=FR'/>"><span
					class="btn btn-important btn-danger">Create DMO Fraccionamiento</span></a>
					
				<a href="<c:url value='/reportExecutionDepartmentDetail.do?id=${department.id}&type=OI'/>"><span
					class="btn btn-important btn-danger">Create Operaciones Import</span></a>
			</div>
		</div>
		<!--/span-->
	</div>
...
<a href="<c:url value='/companyDetail.do?id=${company.id}'/>"><span
