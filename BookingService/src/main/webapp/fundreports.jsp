								...
								<tr>
									...
									<td><c:if
										...
										href="<c:url value="/viewXML.do?id=${reportexecution.id}" />">
											...
											<a class="btn btn-small btn-primary"
												href="<c:url value="/reportFundSend.do?id=${reportexecution.id}" />">
												Send </a>
										</c:if></td>
								</tr>
							</c:if>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
				...
				<a href="<c:url value='/reportExecutionFundDetail.do?id=${fund.id}'/>"><span
					class="btn btn-important btn-danger">Create AIF Report</span></a>
			</div>
		</div>
		<!--/span-->
	</div>
