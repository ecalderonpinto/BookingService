...
<ul class="breadcrumb">
	...
	<li><a href="<c:url value='/fileConfig.do'/>">File Config</a> <i class="icon-angle-right"></i>
	</li>
			...
			<table id="myTable" class="table table-striped table-bordered table-condensed">
				<thead>
					<tr>
						...
						<th>Format<i class="icon-sort"></i></th>
						<th>Number<i class="icon-sort"></i></th>
						<th>Block<i class="icon-sort"></i></th>
						<!-- <th>Description</th> -->
...
<a href="<c:url value='/fileConfig.do'/>"><span
