...
public class ReportExecution implements VersionableAdapter {
	...
	private static final long serialVersionUID = -3034545905549499792L;
	...
	private String reportStatusCount;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	//@JoinColumn(name = "DEPARTMENT_ID", nullable = true, foreignKey = @ForeignKey(name = "T_REPORT_EXE_FK_DEPT"))
	...
	@ManyToOne(fetch = FetchType.LAZY)
	//@JoinColumn(name = "FUND_ID", nullable = true, foreignKey = @ForeignKey(name = "T_REPORT_EXE_FK_FUND"))
	...
	@ManyToOne(fetch = FetchType.LAZY)
	//@JoinColumn(name = "REPORT_GROUP_ID", nullable = true, foreignKey = @ForeignKey(name = "T_REPORT_EXE_FK_GROUP"))
	@JoinColumn(name = "REPORT_GROUP_ID", nullable = true)
	...
	@Column(name = "REPORT_STATUS_COUNT", length = 40)
	public String getReportStatusCount() {
		return this.reportStatusCount;
	}

	public void setReportStatusCount(String reportStatusCount) {
		this.reportStatusCount = reportStatusCount;
	}
