...
public class ReportFieldList implements VersionableAdapter {
	...
	private static final long serialVersionUID = 7776390303150395364L;
	...
	@Column(name = "REPORT_FIELD_LIST_VALUE", length=255)
	...
	@Column(name = "REPORT_FIELD_LIST_DESC", length=1023)
