...
public class FileConfig implements VersionableAdapter {
	...
	private static final long serialVersionUID = 186783537146461385L;
	...
	//@JoinColumn(name = "DEPARTMENT_ID", nullable = true, foreignKey = @ForeignKey(name = "T_FILE_CONFIG_FK_DPTO"))
...
//	@OneToMany(fetch = FetchType.EAGER, mappedBy = "fileConfig")
	...
	public boolean equals(Object object) {
		if (object instanceof FileConfig) {
			return ((FileConfig) object).getId() == (this.id)
