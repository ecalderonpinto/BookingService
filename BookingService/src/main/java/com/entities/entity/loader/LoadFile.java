...
public class LoadFile implements VersionableAdapter {
	...
	private static final long serialVersionUID = -5403698176717658157L;
	...
	//@JoinColumn(name = "DEPARTMENT_ID", nullable = true, foreignKey = @ForeignKey(name = "T_LOAD_FILE_FK_DPTO"))
	...
	public boolean equals(Object object) {
		if (object instanceof LoadFile) {
			return ((LoadFile) object).getId() == (this.id)
