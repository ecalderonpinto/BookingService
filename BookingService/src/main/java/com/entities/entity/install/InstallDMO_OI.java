...
public class InstallDMO_OI implements InstallAdapter {

	private ApplicationContext applicationContext;

	private static final Logger logger = LoggerFactory
			.getLogger(InstallDMO_OI.class);
	...
	public InstallDMO_OI(ApplicationContext applicationContext) {
	...
	public void install() {
		...
		try {
			...
			ReportCatalog reportCatalog = new ReportCatalog(versionField,
					ReportCatalogLevelEnum.DEPARTMENT.getReportLevel(), ReportUtilities.reportCatalogDMO_OI_Name, "",
			...
			ReportField reportFieldx1 = new ReportField(reportCatalog, null,
					"X", "Operaciones Import", new BigInteger("0"), null, "",
