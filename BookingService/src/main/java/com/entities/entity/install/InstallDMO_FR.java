...
public class InstallDMO_FR implements InstallAdapter {

	private ApplicationContext applicationContext;

	private static final Logger logger = LoggerFactory
			.getLogger(InstallDMO_FR.class);

	public static final String nameDatosEntrada = "DMO_DM_2.0 DatosEntrada Fracc";
	public static final String nameOperacionGeneral = "DMO_DM_2.0 OperacionGeneral Fracc";
	public static final String nameOperacion820 = "DMO_DM_2.0 Operacion8_20 Fracc";

	public InstallDMO_FR(ApplicationContext applicationContext) {
	...
	public void install() {
		...
		try {
			...
			ReportCatalog reportCatalog = new ReportCatalog(versionField,
					ReportCatalogLevelEnum.DEPARTMENT.getReportLevel(), ReportUtilities.reportCatalogDMO_FR_Name, "",
			...
			ReportField reportFieldx1 = new ReportField(reportCatalog, null,
					"X", "Fraccionamiento", new BigInteger("0"), null, "",
			...
			fileColums0.add(new FileColum(reportField6, fileConfig0, "type",
					...
					versionAdmin));
			fileColums0.add(new FileColum(reportField7, fileConfig0, "type",
					new BigDecimal(6), "FechaDesde", "", "format", null,
					versionAdmin));
			fileColums0.add(new FileColum(reportField8, fileConfig0, "type",
					new BigDecimal(7), "FechaHasta", "", "format", null,
					versionAdmin));
			...
			logger.error("Error in installation DMO_FR: " + e.getMessage());
		}
