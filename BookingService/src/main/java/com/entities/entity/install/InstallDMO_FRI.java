...
public class InstallDMO_FRI implements InstallAdapter {

	private ApplicationContext applicationContext;

	private static final Logger logger = LoggerFactory
			.getLogger(InstallDMO_FRI.class);

	public InstallDMO_FRI(ApplicationContext applicationContext) {
	...
	public void install() {
		...
		try {
			...
			ReportCatalog reportCatalog = new ReportCatalog(versionField,
					ReportCatalogLevelEnum.DEPARTMENT.getReportLevel(), ReportUtilities.reportCatalogDMO_FRI_Name, "", null, null, null, versionAdmin);
			...
			ReportField reportFieldx1 = new ReportField(reportCatalog, null,
					"X", "FraccionamientoImportacion", new BigInteger("0"), null,
			...
			ReportField reportField4 = new ReportField(reportCatalog,
					reportFieldx2, "D", "MesDeclaracion", new BigInteger("4"), "(19[0-9]{2}|20[0-9]{2})/([0][1-9]|[1][0-2])", "",
